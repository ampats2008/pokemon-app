...
export const BarChart = (data, {
    ...
    colors = ['blue', 'green', 'red', 'orange', 'purple', 'yellow'], // bar fill color
    ...
    const xGroup = svg.append("g")
        ...
        // This snippet will rotate the X-axis tick labels:
        // (I couldn't figure out how to make this work with the transitions, however. 
        // The labels disappear when transitions occur.):
        // .selectAll("text")  
